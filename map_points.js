...
markers.forEach((data, pointindex) => {
    ...
    if (!references[formattedid]) {
        // Prepare settings
        let categoryvisible = !(formattedid == 'category_halloween_pumpkins' || formattedid == 'category_chicken_burgers' || formattedid == 'category_kerfur_parts' ||
            formattedid == 'category_skulls' || formattedid == 'category_metal_tiles')
