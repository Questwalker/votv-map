...
// -655.8, -600.2 : Skull
    ...
    { // TR_2
        "name": "Transformer #3",
        "description": "Target with <i>sv.target TF_2</i>.<br>The building is neatly organized, with an empty shelf and 3 supply boxes. There are two benches outside.",
        "related_images" : [],
        "category": "Transformers",
        "icon": "./icons/transformer.png",
        "positioning": "poitioned_on_top",
...
document.addEventListener('mouseup', function(event) {
    if (drag.state) {
        ...
        if (clickedWithoutMovement && !touchscreenClickedAPoint) {
            ...
            information_text.innerHTML = 'Click on a point on the map to see some information about what it is and where it\'s located, along with some additional pictures that can help you pinpoint <i>exactly</i> it is or what it looks like.'
